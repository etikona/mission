...
<footer className="bg-pink-600 p-5 text-white mb-0 ">
    ...
    <div className="py-6 bg-pink-600 text-white px-4 mb-0  md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <Link to="https://flowbite.com/">Flowbite™</Link>. All Rights Reserved.
        </span>
